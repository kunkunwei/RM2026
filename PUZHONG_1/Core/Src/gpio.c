...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Motor2_dir_Pin|Motor2_en_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, Motor1_dir_Pin|Motor1_en_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : Motor2_en_Pin */
  ...
  /*Configure GPIO pins : Motor1_dir_Pin Motor1_en_Pin */
