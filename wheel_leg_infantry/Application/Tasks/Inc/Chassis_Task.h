...
#define LEG_LENGTH_MIN 0.115f

//
#define STOP_X_OFFSET 0.00f
...
// 腿部误差控制PID  位置 (双腿协调)
#define ANGLE_ERR_PID_KP 670.0f
...
#define SPIN_BOB_N 1.0f					 // 每圈震荡次数（可调：1=慢晃，2=节奏感，3=快抖）
...
typedef struct
{
	...
	float spinning_direction_delta; // 小陀螺模式中的方向补偿角度（云台目标方向 - 底盘当前方向）
	float tmp;
