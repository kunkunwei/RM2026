...
extern Chassis_power_measure_t chassis_power_measure;
void Can_Task(void const * argument)
{
  ...
  for(;;)
  {
  	...
  	// power=chassis_power_measure.power;
  	printf("power : %.2f\r\n", chassis_power_measure.power);
  		// HAL_UART_Transmit(&huart6, &Chassis_power, 4, 10);
