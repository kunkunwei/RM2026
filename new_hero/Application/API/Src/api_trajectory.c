...
//  * @retval none
//  */
// void SolveTrajectory_Transform(SolveTrajectory_Typedef *SolveTrajectory)
// {
...
//         {
//             SolveTrajectory->target_posure[i].x = 0.f; // upstream MiniPCRxData removed; fill with zeros
//             SolveTrajectory->target_posure[i].y = 0.f;
//             SolveTrajectory->target_posure[i].z = 0.f;
