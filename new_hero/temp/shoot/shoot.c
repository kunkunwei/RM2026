...
static void shoot_limit_speed_set(void);
int16_t CAN2_OK=0,CAN1_OK=0;
shoot_control_t shoot_control;          //射击数据
friction_control_t fric1_M_control,fric2_M_control;      //摩擦轮速度环控制（单列出来用CAN2）
/**
...
void shoot_init(void)
{
    ...
    static const fp32 Friction_speed_pid[3] = {Friction_PID_KP, Friction_PID_KI, Friction_PID_KD}; 
	shoot_control.shoot_mode = SHOOT_STOP;
    //遥控器指针
    shoot_control.shoot_rc = get_remote_control_point();
    //电机指针
    shoot_control.shoot_motor_measure = get_Trigger_Motor_Measure_Point();
	fric1_M_control.fric_motor_measure = get_Fric1_Motor_Measure_Point();
	fric2_M_control.fric_motor_measure = get_Fric2_Motor_Measure_Point();
    //初始化PID
    PID_Init(&shoot_control.trigger_motor_pid, PID_POSITION, Trigger_speed_pid, TRIGGER_READY_PID_MAX_OUT, TRIGGER_READY_PID_MAX_IOUT);
    PID_Init(&fric1_M_control.fric_motor_pid, PID_DELTA, Friction_speed_pid, Friction_PID_MAX_OUT, Friction_PID_MAX_IOUT);
	PID_Init(&fric2_M_control.fric_motor_pid, PID_DELTA, Friction_speed_pid, Friction_PID_MAX_OUT, Friction_PID_MAX_IOUT);
	//更新数据
...
int16_t shoot_control_loop(void)
{
    ...
    {
        shoot_control.given_current = 0;
		fric1_M_control.speed_set = 0;
		fric2_M_control.speed_set = 0;
		PID_Calc(&fric1_M_control.fric_motor_pid, fric1_M_control.speed, fric1_M_control.speed_set);
        fric1_M_control.given_current = (int16_t)(fric1_M_control.fric_motor_pid.out);
		PID_Calc(&fric2_M_control.fric_motor_pid, fric2_M_control.speed, fric2_M_control.speed_set);
		fric2_M_control.given_current = (int16_t)(fric2_M_control.fric_motor_pid.out);
    ...
    else
    {
		...
		//设定摩擦轮转速
		/*可以将射速上线和目标转速转为线性关系*/
		fric1_M_control.speed_set = 6000;
		fric2_M_control.speed_set = -6000;
		//计算摩擦轮电机PID
		PID_Calc(&fric1_M_control.fric_motor_pid, fric1_M_control.speed, fric1_M_control.speed_set);
        fric1_M_control.given_current = (int16_t)(fric1_M_control.fric_motor_pid.out);
		PID_Calc(&fric2_M_control.fric_motor_pid, fric2_M_control.speed, fric2_M_control.speed_set);
...
static void shoot_feedback_update(void)
{
	...
	//获取摩擦轮电机转速
	fric1_M_control.speed = fric1_M_control.fric_motor_measure->speed_rpm;//rad/min
	fric2_M_control.speed = fric2_M_control.fric_motor_measure->speed_rpm;
#if TRIGGER_TURN
...
const friction_control_t *get_shoot_fric1_control_point(void)
{
    return &fric1_M_control;
}
const friction_control_t *get_shoot_fric2_control_point(void)
{
    return &fric2_M_control;
}
...
//    {
//    case 15:
//        fric1_M_control.speed_set = 5000;
//		fric2_M_control.speed_set = -5000;
//        break;
//    case 18:
//        fric1_M_control.speed_set = 6000;
//		fric2_M_control.speed_set = -6000;
//        break;
//    case 25:
//        fric1_M_control.speed_set = 6900;
//		fric2_M_control.speed_set = -6900;
//        break;
//    default:
//		fric1_M_control.speed_set = 6500;
//		fric2_M_control.speed_set = -6500;
//        break;
//    }
//}
