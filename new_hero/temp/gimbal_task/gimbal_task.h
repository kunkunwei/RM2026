...
#define PITCH_GYRO_ABSOLUTE_PID_KP 35.0f//12.0f//20.0f
#define PITCH_GYRO_ABSOLUTE_PID_KI 7.9f//0.03f  //0.01f
...
//yaw 速度环 PID参数以及 PID最大输出，积分输出
	...
	#define YAW_SPEED_PID_KI 6.0f
	#define YAW_SPEED_PID_KD 0.0f
	#define YAW_SPEED_PID_MAX_OUT 30000.0f
	#define YAW_SPEED_PID_MAX_IOUT 16000.0f
#endif
 
//yaw 角度环 角度由陀螺仪解算 PID参数以及 PID最大输出，积分输出
#if auto_state
	#define YAW_GYRO_ABSOLUTE_PID_KP 18.0f  //18.0f
	#define YAW_GYRO_ABSOLUTE_PID_KI 0.05f
	#define YAW_GYRO_ABSOLUTE_PID_KD 0.4f  //0.4f
...
#else
	#define YAW_ENCODE_RELATIVE_PID_KP 12.0f
#endif
