...
void MX_FREERTOS_Init(void) {
  ...
  /* USER CODE END Init */
  /* Create the mutex(es) */
  /* definition and creation of can_cmd_mutex */
  osMutexDef(can_cmd_mutex);
  can_cmd_mutexHandle = osMutexCreate(osMutex(can_cmd_mutex));
