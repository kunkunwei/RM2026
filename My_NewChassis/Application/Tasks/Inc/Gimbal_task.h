...
/* PITCH轴角度限制 */
#define MAX_PITCH_RAD 0.25f  // 最大俯仰角度（弧度）
#define MIN_PITCH_RAD -0.25f // 最小俯仰角度（弧度）
///////////////////////////////
/* 发射系统参数设置 */
...
/* PITCH轴速度环PID参数 */
#define PITCH_SPEED_PID_KP       5000.0f  // 比例系数
#define PITCH_SPEED_PID_KI       0.0f     // 积分系数
#define PITCH_SPEED_PID_KD       0.0f     // 微分系数
#define PITCH_SPEED_PID_MAX_OUT  16000.0f // PID最大输出
#define PITCH_SPEED_PID_MAX_IOUT 1600.0f  // PID最大积分输出

/* PITCH轴角度环PID参数（基于陀螺仪解算角度） */
#define PITCH_GYRO_ABSOLUTE_PID_KP       50000.0f // 比例系数
#define PITCH_GYRO_ABSOLUTE_PID_KI       40.0f    // 积分系数
#define PITCH_GYRO_ABSOLUTE_PID_KD       20.888f  // 微分系数
#define PITCH_GYRO_ABSOLUTE_PID_MAX_OUT  16000.0f // PID最大输出
#define PITCH_GYRO_ABSOLUTE_PID_MAX_IOUT 3000.0f  // PID最大积分输出

/* YAW轴速度环PID参数 */
#define YAW_SPEED_PID_KP       2.66f  // 比例系数
...
#define YAW_GYRO_ABSOLUTE_PID_KP       20.0f // 比例系数
...
typedef struct
{
    ...
    bool_t shoot_ready_flag; // 发射准备标志
    bool_t pull_is_block;    // 拨弹轮堵转标志
} gimbal_shoot_t;
...
typedef struct
{
    ...
    dji_motor_measure_t *pitch_motor_measure; // PITCH轴电机测量数据指针
...
typedef struct
{
    ...
    const Remote_Info_Typedef *gimbal_RC; // 遥控器信息指针
